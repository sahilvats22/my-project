    ...
    <div>
      ...
      <section class="signup">
        ...
        <img
          ...
          src={require("../images/tutors-bg.jpg")}
        />
        <h2 class="signup__title">
          find <span>students.</span>
        </h2>
        <form id="tutor__signup" ref={Form} onSubmit={(e) => {
          e.preventDefault();
          toast.success('You have successfully signed up! We will list you on our student page soon.');
          Form.current.reset();
        }} class="signup__form">
          ...
          <div class="signup__form-row lg radio">
            <label class="signup__form-row-label"> Your Topics </label>
            <br />
            <input
              class="check-input"
              type="checkbox"
